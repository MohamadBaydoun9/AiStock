...
const getProducts = ()=>{
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        if (!/*TURBOPACK member replacement*/ __turbopack_context__.g.mockProducts) {
            /*TURBOPACK member replacement*/ __turbopack_context__.g.mockProducts = [];
        }
        return /*TURBOPACK member replacement*/ __turbopack_context__.g.mockProducts;
    }
...
async function PUT(request, { params }) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(products[index]);
    } catch (error) {
