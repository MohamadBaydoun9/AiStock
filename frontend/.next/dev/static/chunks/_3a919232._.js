    ...
    const uniqueTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[uniqueTypes]": ()=>{
            return Array.from(new Set(products.map({
                "DashboardPage.useMemo[uniqueTypes]": (p)=>p.productType
            }["DashboardPage.useMemo[uniqueTypes]"])));
        }
    }["DashboardPage.useMemo[uniqueTypes]"], [
        products
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[stats]": ()=>{
            ...
            const totalValue = products.reduce({
                "DashboardPage.useMemo[stats].totalValue": (sum, p)=>sum + p.price * p.quantity
            }["DashboardPage.useMemo[stats].totalValue"], 0);
            const totalItems = products.reduce({
                "DashboardPage.useMemo[stats].totalItems": (sum, p)=>sum + p.quantity
            }["DashboardPage.useMemo[stats].totalItems"], 0);
            return {
                totalProducts,
                totalValue,
                totalItems
...
_s(DashboardPage, "0/A7SuNB/MVXknifPTrvYEXhzsU=", false, function() {
    return [
...
//# sourceMappingURL=_3a919232._.js.map